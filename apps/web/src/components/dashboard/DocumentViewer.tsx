...
import { 
  FileText, X, ArrowLeft, Search, Download, Printer, 
...
export function DocumentViewer({ sourceLabel, onClose }: DocumentViewerProps) {
  return (
    <div className="fixed inset-0 z-50 flex bg-[var(--color-surface)] animate-fade-in">
      {/* Sidebar Navigation */}
      <div className="w-16 border-r border-[var(--color-border)] flex flex-col items-center py-4 bg-[var(--color-surface)] z-10 shrink-0">
        <button className="p-3 bg-blue-50 text-blue-600 rounded-lg mb-8 relative">
          <File className="w-6 h-6" />
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-blue-600 rounded-r-full"></div>
          <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 text-[10px] font-medium text-blue-600">Pages</span>
        </button>
        <button className="p-3 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg mb-6 group relative">
          <Search className="w-6 h-6" />
          <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 text-[10px] font-medium text-gray-500 opacity-0 group-hover:opacity-100">Search</span>
        </button>
        <button className="p-3 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg mb-6 group relative">
          <Download className="w-6 h-6" />
          <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 text-[10px] font-medium text-gray-500 opacity-0 group-hover:opacity-100">Download</span>
        </button>
        <button className="p-3 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg group relative">
          <Printer className="w-6 h-6" />
          <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 text-[10px] font-medium text-gray-500 opacity-0 group-hover:opacity-100">Print</span>
        </button>
      </div>

      <div className="flex-1 flex flex-col h-full overflow-hidden">
        {/* Top Header */}
        <div className="h-16 border-b border-[var(--color-border)] flex items-center justify-between px-4 bg-[var(--color-surface)] z-10 shrink-0">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 text-gray-500">
              ...
              <button className="p-2 hover:bg-gray-50 rounded"><Download className="w-5 h-5" /></button>
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Thumbnails Panel */}
          <div className="w-64 border-r border-[var(--color-border)] bg-gray-50/50 flex flex-col shrink-0">
            <div className="p-4 flex items-center justify-between">
              <span className="text-sm font-semibold text-gray-700">Pages</span>
              <button className="text-gray-400 hover:text-gray-600"><ChevronsLeft className="w-4 h-4" /></button>
            </div>
            <div className="p-4 flex-1 overflow-auto">
              <div className="mb-4">
                <div className="w-full aspect-[1/1.4] bg-white border-2 border-blue-500 rounded shadow-sm relative p-2 mb-2">
                  {/* Miniature skeleton of the document */}
                  <div className="w-1/3 h-2 bg-gray-200 mb-4 rounded"></div>
                  <div className="w-full h-8 bg-gray-50 mb-2 rounded border border-gray-100"></div>
                  <div className="w-full h-8 bg-gray-50 mb-4 rounded border border-gray-100"></div>
                  <div className="flex gap-2 mb-4">
                    <div className="flex-1 h-16 bg-gray-50 rounded border border-gray-100"></div>
                    <div className="flex-1 h-16 bg-gray-50 rounded border border-gray-100"></div>
                  </div>
                  <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-[10px] font-bold px-2 py-0.5 rounded">1</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 bg-[#323639] overflow-auto flex justify-center p-8 relative">
            
            {/* The Document */}
            <div className="bg-white w-[850px] shrink-0 min-h-[1100px] shadow-2xl rounded-lg overflow-hidden flex flex-col mb-16 relative">
              
              {/* Highlight Background Graphic */}
              <div className="absolute top-0 right-0 w-96 h-96 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-50/50 via-white to-white pointer-events-none"></div>
              ...
              <div className="px-16 pt-16 pb-12 relative z-10 flex flex-col h-full">
                {/* Header */}
        ...
        {/* Bottom Footer Bar */}
        <div className="h-16 border-t border-[var(--color-border)] flex items-center justify-between px-6 bg-[var(--color-surface)] z-10 shrink-0">
